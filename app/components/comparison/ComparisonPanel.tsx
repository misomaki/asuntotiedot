...
function BuildingAgeComparison({ buildingsA, buildingsB }: BuildingAgeComparisonProps) {
  const segments: { label: string; color: string; keyA: keyof NonNullable<AreaWithStats['buildings']>; keyB: keyof NonNullable<AreaWithStats['buildings']> }[] = [
    { label: 'ennen 1960', color: '#b898c0', keyA: 'pct_pre_1960', keyB: 'pct_pre_1960' },
    { label: '1960-1980', color: '#d4a0b8', keyA: 'pct_1960_1980', keyB: 'pct_1960_1980' },
    { label: '1980-2000', color: '#e8d098', keyA: 'pct_1980_2000', keyB: 'pct_1980_2000' },
    { label: '2000 jalkeen', color: '#8cc8b8', keyA: 'pct_post_2000', keyB: 'pct_post_2000' },
  ]
  ...
  return (
    <div className="grid grid-cols-[1fr_auto_1fr] gap-2 items-center">
      <div className="flex justify-center">
        {scoreA != null ? (
          <WalkScoreComparisonCircle score={scoreA} color="#d4a0b8" />
        ) : (
      ...
      <div className="flex justify-center">
        {scoreB != null ? (
          <WalkScoreComparisonCircle score={scoreB} color="#8cc8b8" />
        ) : (
          <span className="text-sm text-muted-foreground">Ei tietoa</span>
        )}
      </div>
