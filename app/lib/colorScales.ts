...
export const PRICE_COLORS = [
  '#1e1b4b', // < 1000  (deep indigo)
  '#312e81', // 1000-1500
  '#115e59', // 1500-2000 (dark teal)
  '#0d9488', // 2000-2500 (teal)
  '#2dd4bf', // 2500-3000 (bright teal)
  '#a3e635', // 3000-4000 (lime transition)
  '#facc15', // 4000-5000 (yellow)
  '#f59e0b', // 5000-7000 (amber)
  '#b45309', // > 7000   (deep amber)
]
