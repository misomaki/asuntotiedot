-- ============================================================
-- Migration 023: Recalibrate OKT fallback multipliers
--
-- OKT_FALLBACK.fromRivitalo: 1.10 → 1.00
-- OKT_FALLBACK.fromKerrostalo: 0.90 → 0.75
--
-- Analysis of 1,832 Etuovi OKT listings showed:
--   - National OKT/RT price ratio is 1.04, not 1.10
--   - Outside Helsinki/Espoo, OKT is equal or cheaper than RT
--   - OKT/KT ratio is ~0.70 nationally, not 0.90
--   - Neighborhood factors already capture city-level premiums
--
-- After deploying:
