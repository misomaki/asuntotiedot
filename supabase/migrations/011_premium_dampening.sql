-- ============================================================
-- Premium dampening + municipality median fallback
-- ============================================================
-- Fixes price overestimation for 1950-1970 era buildings:
--   1. Dampens premium factors (neighborhood, water) for old buildings
--   2. Changes municipality fallback from AVG to MEDIAN (PERCENTILE_CONT)
--
-- After deploying this:
--   1. Re-run neighborhood factor computation (with year=0 filter)
