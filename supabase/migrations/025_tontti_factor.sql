-- ============================================================
-- Migration 025: Add tontti factor to compute_building_price()
--
-- Applies a 0.92 discount for kerrostalo/rivitalo on
-- municipality-owned leased plots (vuokratontti).
-- Matches TONTTI_FACTOR_LEASED in priceEstimation.ts.
--
-- After deploying:
--   1. Reset Tampere: UPDATE buildings SET estimation_year = NULL
--      FROM areas WHERE buildings.area_id = areas.id AND areas.municipality = 'Tampere';
...
-- ============================================================
-- Update compute_all_building_prices to pass is_leased_plot
-- ============================================================
