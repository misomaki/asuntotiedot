-- ============================================================
-- Migration 022: Sync SQL price factors with TypeScript
--
-- Three changes to align compute_building_price() with
-- app/lib/priceEstimation.ts (recalibrated 2026-04-01):
--
--   1. Age factors: 60% correction for new builds, fine-tuned
--      middle/old brackets against 535 staging listings
--   2. Water dampening removed: waterfront is a permanent
--      physical attribute (views, dock) — doesn't depreciate
--   3. Size factor: now computed from apartment_count and
--      footprint_area_sqm (passed from compute_all_building_prices)
--
-- After deploying:
...
BEGIN
  ...
  -- 60% correction for new builds against 535 staging listings.
  -- Middle brackets anchored at near-zero validation error.
  -- ========================================================
...
-- ============================================================
-- Update compute_all_building_prices to pass size factor params
-- ============================================================
...
BEGIN
  ...
  SET
    estimated_price_per_sqm = compute_building_price(
      ...
      apartment_count, footprint_area_sqm
    ),
