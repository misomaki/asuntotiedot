-- ============================================================
-- Migration 034: Fix OKT fallback sync + widen neighborhood clamp
--
-- Two fixes to align compute_building_price() with
-- app/lib/priceEstimation.ts:
--
--   1. OKT fallback multipliers: 1.10/0.90 → 1.00/0.75
--      (synced with OKT_FALLBACK in priceEstimation.ts)
--
--   2. Neighborhood factor clamp: 0.70 lower bound → 0.50
--      (cheap areas need stronger discounts, e.g. Hervanta -40%)
--
-- After deploying:
--   1. Recompute neighborhood factors:
--      npx tsx scripts/data-import/09-compute-neighborhood-factors.ts
--   2. Reset: UPDATE buildings SET estimation_year = NULL, estimated_price_per_sqm = NULL;
--   3. Recompute: npx tsx scripts/data-import/05-compute-building-prices.ts
-- ============================================================
...
BEGIN
  ...
  -- Clamp widened to [0.50, 1.50] (was [0.70, 1.50])
  -- to allow stronger discounts for cheap areas
  -- ========================================================
  ...
  -- Cheap areas overestimated, premium areas underestimated
  -- ========================================================
...
-- ============================================================
-- Update compute_all_building_prices (unchanged logic, just
-- re-declares to pick up updated compute_building_price)
-- ============================================================
